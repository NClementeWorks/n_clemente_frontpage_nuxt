...
<template>
  <svg width="282" height="619" viewBox="0 0 282 619" xmlns="http://www.w3.org/2000/svg"
    ...
    <defs>
      ...
      <linearGradient id="paint1_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
      <linearGradient id="paint2_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
      <linearGradient id="paint3_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
      <linearGradient id="paint4_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
      <linearGradient id="paint5_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
      <linearGradient id="paint6_linear_1432_2175" x1="271.226" y1="595.347" x2="21.8945" y2="149.532" gradientUnits="userSpaceOnUse">
        <stop stop-color="#32DEB3" />
        <stop offset="0.536499" stop-color="#1DBBE2" />
        <stop offset="1" stop-color="#ED24F4" />
      </linearGradient>
